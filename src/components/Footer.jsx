            ...
            <div>
              ...
              <ul className="text-gray-100 dark:text-gray-400 font-medium">
                <li className="mb-4 cursor-pointer">
                  <a target="_blank" href="https://www.instagram.com/techoland/" className="hover:underline">
                ...
                <li className="mb-4 cursor-pointer">
                  <a target="_blank" href="https://wa.me/584123653885" className="hover:underline">
                    <div className="flex gap-2">
                      <svg class="w-6 h-6 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                ...
                <li className="mb-4 cursor-pointer">
                  <a target="_blank" href="mailto:techoland.ventas@gmail.com" className="hover:underline">
                    <div className="flex gap-2">
                      <svg class="w-6 h-6 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                ...
                <li className="mb-4 cursor-pointer">
                  <div >
                    <div className="flex gap-2">
                      ...
                      <a className="hover:underline" target="_blank" href="tel:+582129852232">0212-9852232</a>/ <a className="hover:underline" href="tel:+582125162313">0212-5162313</a>
                    </div>
                  </div>
                </li>
