...
const Banner = () => {
  return (
    <div className="flex w-full justify-center flex-col text-center h-[40rem]">
      ...
      <p className="mb-8 text-lg font-normal text-gray-300 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-400">Tenemos 20 años de experiencia en estructuras y cubiertas para techos.
        Garantizamos el cuidado de las láminas desde su traslado y aseguramos una correcta instalación.</p>
